package net.gringo.capitangringosmods.util;
...
public class ModItemProperties {
    public static void addCustomItemProperties() {
        makeCustomSlingshot(ModItems.SLINGSHOT.get());
    }

    private static void makeCustomSlingshot(Item item) {
        ...
        ItemProperties.register(
                ...
                (p_174630_, p_174631_, p_174632_, p_174633_) -> p_174632_
                        != null && p_174632_.isUsingItem() && p_174632_.getUseItem() == p_174630_ ? 1.0F : 0.0F
        );
    }
}
