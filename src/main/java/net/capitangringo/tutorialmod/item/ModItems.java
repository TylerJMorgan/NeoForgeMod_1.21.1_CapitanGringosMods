package net.capitangringo.tutorialmod.item;

import net.capitangringo.tutorialmod.TutorialMod;
...
// Make sure the textures (assets/tutorialmod/textures) are 16x16 pngs (if you want it to match other Minecraft stuff)
